...
int main()
{
 ...
 /*   when having no copy constructor the same problem happens

        here we don't have passing by value or reference,
        because we are studying the return of a fn. called Reverse.

        At the end of the fn. R and it's copy  the will both have conflict

        one of them will free the memory first and then the follwing one will not find
        anything to de-allocate.
        ...
        resulting in -- >
                        ...
                        ctor -- 2 ( S1 and R )
                        dest -- 3 ( S1 and R) and sometimes the copied version
                                            is able to call the dest. succesfully.
