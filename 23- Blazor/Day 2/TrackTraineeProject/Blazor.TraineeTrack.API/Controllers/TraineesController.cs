...
namespace Blazor.TraineeTrack.API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TraineesController : ControllerBase
    {
        private readonly MyTraineeTrackDBContext _context;

        public TraineesController(MyTraineeTrackDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Trainee>> PostTrainee(Trainee trainee)
        {
          if (_context.Trainees == null)
          {
              return Problem("Entity set 'MyTraineeTrackDBContext.Trainees'  is null.");
          }
